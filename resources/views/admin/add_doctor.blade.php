...
@include('admin.css');
  ...
  <body>
    <div class="container-scroller">
      ...
      @endif
        <form action="{{url('upload_doctor')}}" method="POST" enctype="multipart/form-data" onsubmit="return valiid(); ">
      ...
      <input type="number" name="number" id="number" style="color:black; width: 270px;" placeholder="Doctor's Number " required="" >
        ...
        <input type="text" name="speciality" id="speciality" style="color:black; width: 270px;"placeholder="Doctor's Speciality" required="">
        </div>
        ...
        <input type="number" name="id" id="id" style="color:black; width: 270px;" placeholder="Doctor's ID" required="">
        </div>

        <div style="padding: 15px;">
        <label for="" style=" width: 100px;">Doctor Salary </label>
        <input type="number" name="salary" id="salary" style="color:black; width: 270px;" placeholder="Doctor's Salary" required="">
        </div>
